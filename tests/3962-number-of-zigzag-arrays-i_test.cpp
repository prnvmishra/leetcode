#include "lc_test.h"
#include "../3962-number-of-zigzag-arrays-i/number-of-zigzag-arrays-i.cpp"

// Brute-force reference: count length-n arrays with values in [1,m] that have
// no equal adjacent elements and no three-in-a-row monotonic run.
